...
cred = credentials.Certificate("/home/pi/Capstone_EveryKid/Raspberry pi/firebase/people-6bda1-firebase-adminsdk-3z19w-1c304b3e10.json") #(키 이름 ) 부분에 본인의 키이름을 적어주세요.
default_app = firebase_admin.initialize_app(cred,{'storageBucket':f"people-6bda1.appspot.com"})
...
def fileUpload(file):
    ...
    #upload file
    blob.upload_from_filename(filename='/home/pi/Capstone_EveryKid/Raspberry pi/firebase'+file, content_type='image/png') #파일이 저장된 주소와 이미지 형식(jpeg도 됨)
    #debugging hello
    print("hello ")
...
def execute_camera():
    ...
    camera.capture('/home/pi/Capstone_EveryKid/Raspberry pi/firebase' + filename)
...
def clearAll():
    ...
    path = '/home/pi/Capstone_EveryKid/Raspberry pi/firebase'
